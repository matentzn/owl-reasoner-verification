...
/**
 * Author: Nicolas Matentzoglu<br> The University of Manchester<br> Information Management Group<br>
 * Date: 18-Feb-2015
 */
public class JustPorgressMonitor<E> implements ExplanationProgressMonitor<E> {
